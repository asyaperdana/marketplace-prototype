    ...
    const protectionFeatures: ProtectionFeature[] = [
        {
            ...
            title: "Sistem Escrow",
            description:
                "Dana pembeli aman hingga barang diterima. Tidak ada risiko penipuan.",
        },
        {
            icon: "✅",
            title: "Verifikasi Seller",
            description:
                "Setiap seller melewati proses verifikasi identitas ketat.",
        },
        {
            icon: "💰",
        ...
        },
        {
            ...
            description:
                "Perlindungan penuh untuk setiap transaksi di platform.",
        },
        {
            icon: "💬",
            title: "Support 24/7",
    ...
    <div class="container mx-auto px-6 relative z-10">
        ...
        >
            ...
            <p class="text-xl text-slate-300 max-w-2xl mx-auto">
                Kami melindungi setiap transaksi dengan sistem keamanan berlapis
            ...
            <div class="grid grid-cols-1 md:grid-cols-5 gap-6 items-center">
                <div class="flex flex-col items-center text-center group">
                    ...
                    <span class="text-xs text-slate-400"
                        >Buyer bayar produk</span
                    >
                </div>
                <div
                    class="hidden md:flex items-center justify-center text-primary/50"
                >
                    <svg
                        class="w-8 h-8"
                        fill="none"
                ...
                <div class="flex flex-col items-center text-center group">
                    ...
                    <span class="font-bold text-white mb-1"
                        >2. Dana Ditahan</span
                    >
                    <span class="text-xs text-slate-400"
                        >Okis GS simpan aman</span
                    >
                </div>
                <div
                    class="hidden md:flex items-center justify-center text-primary/50"
                ...
                <div class="flex flex-col items-center text-center group">
                    ...
                    <span class="font-bold text-white mb-1"
                        >3. Dana Diteruskan</span
                    >
                    <span class="text-xs text-slate-400"
                        >Setelah buyer konfirmasi</span
                    >
                </div>
            </div>
        </div>
            ...
            >
                ...
                <div class="grid grid-cols-4 gap-3">
                    {#each paymentMethods as method}
                        ...
                        >
                            <div
                                class="text-2xl mb-1 group-hover:scale-110 transition-transform"
                            >
                                {method.icon}
                            </div>
