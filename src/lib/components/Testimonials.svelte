...
>
    ...
    <div class="container mx-auto px-6 relative z-10 max-w-5xl">
        ...
        >
            <h2
                class="text-4xl lg:text-5xl font-black text-white tracking-tighter"
            >
                Apa Kata <span class="gradient-text">Mereka</span>?
            </h2>
            <p class="text-xl text-slate-300 max-w-2xl mx-auto">
                Ribuan pengguna telah membuktikan kemudahan bertransaksi di
                platform kami.
            </p>
        </div>
        ...
        >
            {#each testimonials as _, index}
                <button
                    class="h-3 rounded-full transition-all duration-500 {currentIndex ===
                    index
