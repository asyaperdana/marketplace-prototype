    ...
    const sellerSteps: Step[] = [
        {
            ...
            description:
                "Foto barang dari berbagai angle dengan pencahayaan yang baik.",
        },
        {
            number: 2,
            icon: "📝",
            ...
            description:
                "Tambahkan deskripsi, kondisi, harga, dan kategori produk.",
        },
        {
            number: 3,
            icon: "📢",
        ...
        },
        {
            ...
            description:
                "Dana masuk ke saldo setelah pembeli konfirmasi terima.",
        },
    ];
    ...
    const buyerSteps: Step[] = [
        {
            ...
            description:
                "Browse atau search produk sesuai kategori yang kamu mau.",
        },
        {
            number: 2,
            icon: "💬",
            ...
            description:
                "Tanya detail, negosiasi harga, dan pastikan kondisi barang.",
        },
        {
            number: 3,
            icon: "💳",
        ...
        },
        {
            ...
            title: "Terima Barang",
            description:
                "Tunggu pengiriman dan konfirmasi jika barang sudah sampai.",
        },
    ];
    ...
    <div class="container mx-auto px-6 relative z-10">
        ...
        >
            ...
            <p class="text-xl text-slate-300 max-w-2xl mx-auto">
                Langkah-langkah mudah untuk mulai berjualan atau berbelanja
                barang berkualitas.
            </p>
        </div>
        ...
        >
            <div
                class="inline-flex glass-light p-2 rounded-[2rem] border border-white/10 relative"
            >
                <button
        ...
        <!-- Steps Visualization -->
        <div
            class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 relative"
        >
        ...
        >
            {#if activeTab === "seller"}
                <a
                    href="#newsletter"
                    class="btn btn-primary px-12 py-5 text-xl group"
                >
