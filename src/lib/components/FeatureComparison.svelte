...
>
    ...
    <div class="container mx-auto px-6 relative z-10 max-w-5xl">
        ...
        >
            <!-- Table Header -->
            <div
                class="grid grid-cols-4 gap-4 p-6 border-b border-white/10 bg-white/5"
            >
                <div
                    class="font-bold text-slate-400 text-sm uppercase tracking-widest"
                >
                    Fitur
                </div>
            ...
            <div class="divide-y divide-white/5">
                {#each comparisonData as row, index}
                    ...
                    >
                        <div
                            class="font-medium text-slate-200 flex items-center"
                        >
                            {row.feature}
                        </div>
