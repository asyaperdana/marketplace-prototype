    ...
    <div class="container mx-auto px-6 relative z-10 max-w-4xl">
        ...
        >
            ...
            <div class="relative z-10">
                ...
                >
                    Dapatkan info promo spesial, tips jual-beli aman, dan
                    koleksi produk terbaru langsung di inbox kamu.
                </p>
                ...
                <div class="flex flex-wrap justify-center gap-10 md:gap-16">
                    <div
                        class="flex items-center gap-4 text-slate-100 group/item"
                    >
                        <div
